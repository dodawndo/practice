...
<body>
	<div id="wrap">
		...
		<article>
			<h1>회원가입</h1>
			<form action="MemberJoinPro.func" method="post" id="join" name="fr">
				<fieldset>
					<legend>회원가입</legend>
					<label>아이디</label><br>
						<input type="text" name="id" id="id"  placeholder="아이디를 입력해주세요"><br>
					<label>비밀번호</label><br>
						<input type="password" name="pass" id="pass"  placeholder="영문 + 숫자 + 특수문자 8자 이상">
					<br>	
						<input type="password" name="pass" id="pass"  placeholder="비밀번호 확인"><br>
					<label>닉네임</label><br>
						<input type="text" name="nick" id="nick" placeholder="닉네임을 입력해주세요"><br> 
					<label>이메일</label><br>
						<input type="email" name="email" id="email" placeholder="이메일을 입력해주세요"><br>
					<label>생년월일</label><br>
						<input type="text" name="nick" id="birth" placeholder="닉네임을 입력해주세요"><br> 
					<label>전화번호</label><br>
						<input type="number" name="phone" id="phone" placeholder="전화번호입력"><input type="button" value="인증요청"><br>
